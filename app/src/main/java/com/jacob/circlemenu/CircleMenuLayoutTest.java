 ...
 * </pre>
 */
public class CircleMenuLayoutTest extends ViewGroup
{
    private int mRadius;
    /**
     * 该容器内child item的默认尺寸
    ...
    private int mMenuItemLayoutId = R.layout.layout_menu_item;

    public CircleMenuLayoutTest(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        // 无视padding
        setPadding(0, 0, 0, 0);
    ...
    private void addMenuItems()
    {
        ...
        for (int i = 0; i < mMenuItemCount; i++)
        {
            ...
            ImageView iv = (ImageView) view
                    .findViewById(R.id.image_view_menu);
            TextView tv = (TextView) view
                    .findViewById(R.id.text_view_menu);
